...
<?php $catquery = new WP_Query( array( 'post_type' => 'portfoliosz'));
$postid = $_GET["post_id"];
?>
<div class="container container-full">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
    <h1 class="margin-top-xlarge"><span class="orange-heading">Resource</span> <span class="white-heading">Library</span><br>
      <br>
    </h1>
  </div>
</div>
<div class="container fill  paddingnone">
    ...
    <?php
		if (($postid) == '') {
			$query = new WP_Query( array( 'post_type' => 'portfoliosz', 'posts_per_page' => 1)); ?>
	 <?php if (have_posts()): while($query->have_posts()) : $query->the_post();  
	 $postid = get_the_ID();  
	 ?>
      <h3 class="dark-heading"><?php echo get_the_title( ); ?></h3>
      <p class="dark-heading"><?php echo get_post_field('post_content'); ?> </p>
      <a href="portfolio-single.php?post_id=<?php echo $postid ?>" class="btn read-more">View More</a>
      <?php endwhile; endif; }
	  else {
		  $postid = $_GET["post_id"]; ?>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 paddingnone fill-black">
      ...
      <div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 paddingnone">
         <?php if (class_exists('MultiPostThumbnails')
          ...
          <div class="case-study"> <a href="portfolio-archive.php?post_id=<?php echo $postid ?>">
            <div class="overlay">
